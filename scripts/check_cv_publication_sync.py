...
This intentionally does not rewrite the CV files. The CV keeps curated ordering
and notes, so the script reports missing BibTeX titles and prints draft LaTeX
items that can be reviewed before insertion.
"""
