...
\newcommand{\scholarstats}{\href{https://scholar.google.com/citations?user=2qgIJwwAAAAJ\&hl=zh-CN}{\scholaricon\hspace{0.25em}\underline{谷歌学术引用}}：2,074，h-index：18，热点论文：1，高被引论文：2}
...
\fancyfoot[L]{\footnotesize 最近更新：2026年5月24日}
...
{\fontsize{12}{14}\selectfont\textbf{香港理工大学校长杰出博士后}}\par
香港理工大学建筑环境及能源工程学系\par
香港九龙红磡漆咸道南181号，香港理工大学Z座ZN1001室\par
\href{mailto:zhechen@polyu.edu.hk}{zhechen@polyu.edu.hk}

% =============================================================================
%  PROFILE
% =============================================================================
\cvsection{个人简介}{个人简介}
陈喆，香港理工大学校长杰出博士后，入选香港理工大学校长卓越博士生奖学金计划、杰出博士后研究员计划，并荣获香港理工大学建设及环境学院杰出博士论文奖。主要从事人工智能驱动建筑运维、建筑能源系统优化、故障诊断、需求响应、冷站优化及节能量不确定性评估等方面研究。累计发表学术论文30余篇，Google Scholar引用2,074次，h-index为18；其中1篇入选ESI热点论文，2篇入选ESI高被引论文。

以第一作者或通讯作者在\textit{Renewable and Sustainable Energy Reviews}、\textit{Advances in Applied Energy}、\textit{Sustainable Cities and Society}、\textit{Automation in Construction}、\textit{Applied Energy}、\textit{Energy}、\textit{Building and Environment}等国际期刊发表论文。获国际建筑能源灵活性预测挑战赛冠军（排名1/610，奖金AU\$10,000）、第一届粤港澳大湾区数据应用创新大赛冠军（奖金CN¥100,000）、UNiLAB智慧能源系统大数据分析赛冠军（排名1/513）、施耐德电气AI大施杯智能楼宇能耗预测赛冠军（排名1/331）等。现担任\textit{Carbon Neutrality}青年编委、\textit{Buildings}客座编辑，并长期担任多个国际期刊审稿人。
...
% =============================================================================
\cvsection{获奖经历}{获奖经历}
\begin{longtable}{@{}p{0.75cm} >{\justifying\arraybackslash}p{\dimexpr\textwidth-0.95cm\relax}@{}}
2025 & \textbf{冠军（排名1/610，AU\$10,000）}，FlexTrack Challenge---Detecting Energy Flexibility in Buildings，2025 IEEE International Conference on Energy Technologies for Future Grids \\
2025 & \textbf{建设及环境学院杰出博士论文奖}，香港理工大学（前2.5\%） \\
2025 & \textbf{杰出博士后研究员资助}，香港理工大学 \\
...
2023 & \textbf{冠军（排名1/331）}，施耐德电气AI大施杯智能楼宇能耗预测赛 \\
2023 & \textbf{冠军（排名1/513）}，UNiLAB智慧能源系统大数据分析赛 \\
2023 & \textbf{ESI热点论文和高被引论文}，通讯作者论文``\textit{Physical energy and data-driven models in building energy prediction: A review}'' \\
2023 & \textbf{杰出控制奖}，第21届MDV中央空调设计应用大赛·高校环控组，美的楼宇科技 \\
2022 & \textbf{论文提名奖}，国际埃尼奖Eni Award 2023，第一作者需求响应调度论文 \\
...
\cvsubsection{会议分会主席}{\color{darkblue}会议分会主席}
\begin{enumerate}
...
期刊评审 & 受邀担任多个国际期刊审稿人，包括：\textit{Applied Energy, Energy Conversion and Management, Journal of Cleaner Production, Advanced Engineering Informatics, Engineering Applications of Artificial Intelligence, Computers in Industry, Energy, Building and Environment, Applied Thermal Engineering, Energy and Buildings, Building Simulation, iScience} \\
